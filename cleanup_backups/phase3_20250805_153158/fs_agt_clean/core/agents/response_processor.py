"""
Shared AutonomousAgent Response Processing Utilities
...
from fs_agt_clean.core.models.chat import AutonomousAgentResponse

logger = logging.getLogger(__name__)


class AutonomousAgentResponseProcessor:
    """
    Standardized response processing utilities for conversational agents.

    Eliminates code duplication across ContentAutonomousAgent, LogisticsAutonomousAgent, and ExecutiveAutonomousAgent
    ...
    def _calculate_fallback_confidence(
        ...
        try:
            ...
            # AutonomousAgent-specific factors
    ...
    def create_standardized_response(
        ...
        """
        Create a standardized AutonomousAgentResponse with calculated confidence and metadata.
        ...
        Returns:
            Standardized AutonomousAgentResponse object
        """
        try:
