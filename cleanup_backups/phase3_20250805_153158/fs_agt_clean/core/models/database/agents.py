...
# Legacy AgentType enum - DEPRECATED: Use fs_agt_clean.core.enums.agent_status.AgentType instead
# Kept for backward compatibility with existing database records
class LegacyAgentType(enum.Enum):
    """DEPRECATED: Agent type enumeration - use unified AgentType instead."""
...
# Legacy status and priority enums - DEPRECATED
# These are replaced by imports from fs_agt_clean.core.enums.agent_status


class LegacyAgentStatus(enum.Enum):
    """DEPRECATED: Use fs_agt_clean.core.enums.agent_status.AutonomousAgentStatus instead."""
...
class LegacyAgentPriority(enum.Enum):
...
class AgentModel(Base):
    ...
    status = Column(
        Enum(AutonomousAgentStatus),
        nullable=False,
        default=AutonomousAgentStatus.INITIALIZING,
    )
    ...
    def update_status(
        self, status: AutonomousAgentStatus, health_status: Optional[str] = None
    ):
