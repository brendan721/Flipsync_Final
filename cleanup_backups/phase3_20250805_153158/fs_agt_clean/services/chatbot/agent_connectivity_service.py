"""
AutonomousAgent connectivity service for the FlipSync chatbot.
...
from fs_agt_clean.core.models.chat import (
    AutonomousAgentResponse,
    ChatMessage,
    MessageIntent,
)
from fs_agt_clean.core.models.recommendation import ChatRecommendationContext
from fs_agt_clean.core.services.agent_service import AutonomousAgentService
from fs_agt_clean.services.communication.intent_recognition import IntentRecognizer
...
class AutonomousAgentConnectivityService:
    """
    ...
    def __init__(
        ...
        agent_services: Optional[Dict[str, AutonomousAgentService]] = None,
        ...
        logger.info(
            "AutonomousAgent connectivity service initialized with %d agent services",
    ...
    def register_agent_service(
        self, agent_type: str, service: AutonomousAgentService
    ) -> None:
        """
        ...
        Args:
            ...
            service: AutonomousAgent service instance
        """
    ...
    async def process_message(
        ...
        try:
            ...
            logger.error("Agent import error: %s", str(ie), exc_info=True)
            return AutonomousAgentResponse(
                text="The requested agent is currently unavailable. Trying alternative approach...",
                metadata={
                    "error": str(ie),
            ...
            logger.error("Agent method not found: %s", str(ae), exc_info=True)
            return AutonomousAgentResponse(
                text="The agent method is not available. Using fallback processing...",
                metadata={
                    "error": str(ae),
            ...
            logger.error("Agent method signature mismatch: %s", str(te), exc_info=True)
            return AutonomousAgentResponse(
                text="Agent interface mismatch detected. Attempting compatibility mode...",
                metadata={
                    "error": str(te),
            ...
            logger.error("Connection error: %s", str(ce), exc_info=True)
            return AutonomousAgentResponse(
                text="Unable to connect to external services. Please check your connection and try again.",
                metadata={
                    "error": str(ce),
            ...
            logger.error(
                "Unexpected error processing message: %s", str(e), exc_info=True
            )
            return AutonomousAgentResponse(
    ...
    def _get_agent_type_for_intent(self, intent: MessageIntent) -> Optional[str]:
        ...
        Returns:
            AutonomousAgent type, or None if no matching agent type
        """
