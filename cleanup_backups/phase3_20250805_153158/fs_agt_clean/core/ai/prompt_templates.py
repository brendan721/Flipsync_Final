"""
Prompt Templates for FlipSync AI AutonomousAgents
=======================================
...
class AutonomousAgentRole(str, Enum):
    """AutonomousAgent roles for prompt templates."""
    ...
    def _create_system_prompts(self) -> Dict[str, PromptTemplate]:
        ...
        return {
            "market_system": PromptTemplate(
                role=AutonomousAgentRole.MARKET,
                prompt_type=PromptType.SYSTEM,
                template="""You are a Market Intelligence AutonomousAgent for FlipSync, an expert in e-commerce marketplace analysis and optimization.
...
Always provide practical, implementable advice that directly impacts business performance.""",
                ...
                description="System prompt for Market Intelligence AutonomousAgent",
            ),
            "analytics_system": PromptTemplate(
                role=AutonomousAgentRole.ANALYTICS,
                prompt_type=PromptType.SYSTEM,
                template="""You are an Analytics AutonomousAgent for FlipSync, specializing in business intelligence and performance analysis.
...
Focus on translating complex data into clear, actionable business insights.""",
                ...
                description="System prompt for Analytics AutonomousAgent",
            ),
            "logistics_system": PromptTemplate(
                role=AutonomousAgentRole.LOGISTICS,
                prompt_type=PromptType.SYSTEM,
                template="""You are a Logistics Optimization AutonomousAgent for FlipSync, expert in supply chain and fulfillment operations.
...
Prioritize solutions that balance cost efficiency with customer satisfaction.""",
                ...
                description="System prompt for Logistics AutonomousAgent",
            ),
            "content_system": PromptTemplate(
                role=AutonomousAgentRole.CONTENT,
                prompt_type=PromptType.SYSTEM,
                template="""You are a Content Optimization AutonomousAgent for FlipSync, specializing in marketplace content creation and SEO.
...
Create content that drives both visibility and conversions.""",
                ...
                description="System prompt for Content AutonomousAgent",
            ),
            "executive_system": PromptTemplate(
                role=AutonomousAgentRole.EXECUTIVE,
                prompt_type=PromptType.SYSTEM,
                template="""You are an Executive Decision AutonomousAgent for FlipSync, providing strategic business guidance and high-level decision support.
...
Think strategically and provide guidance that drives sustainable business growth.""",
                ...
                description="System prompt for Executive AutonomousAgent",
            ),
            "assistant_system": PromptTemplate(
                role=AutonomousAgentRole.ASSISTANT,
                prompt_type=PromptType.SYSTEM,
...
Continue the conversation naturally, building on this context.""",
    ...
    def get_system_prompt(
        self, agent_role: AutonomousAgentRole, context_variables: Optional[Dict[str, Any]] = None
    ) -> str:
    ...
    def get_handoff_prompt(
        self, target_agent: AutonomousAgentRole, context_variables: Dict[str, Any]
    ) -> str:
    ...
    def _get_agent_capabilities(self, agent_role: AutonomousAgentRole) -> str:
        """Get capabilities description for an agent role."""
        capabilities = {
            AutonomousAgentRole.MARKET: "pricing analysis, inventory management, competitor monitoring, marketplace optimization",
            AutonomousAgentRole.ANALYTICS: "performance reporting, data visualization, trend analysis, KPI tracking",
            AutonomousAgentRole.LOGISTICS: "shipping optimization, fulfillment management, carrier coordination, cost reduction",
            AutonomousAgentRole.CONTENT: "listing optimization, SEO enhancement, content creation, conversion improvement",
            AutonomousAgentRole.EXECUTIVE: "strategic planning, decision support, risk analysis, business development",
            AutonomousAgentRole.ASSISTANT: "general support, platform guidance, troubleshooting, user assistance",
        }
