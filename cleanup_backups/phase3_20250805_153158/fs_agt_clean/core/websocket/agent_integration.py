"""
WebSocket Integration for Conversational AutonomousAgents
==============================================
...
class ConversationalAutonomousAgentWebSocketIntegration:
    """
    ...
    - AutonomousAgent status broadcasting
    ...
    def __init__(self, approval_service: Optional[ApprovalIntegrationService] = None):
        ...
        self.agent_type_mapping = {
            ...
            "assistant": AutonomousAgentType.ASSISTANT,
        }

        logger.info("Conversational AutonomousAgent WebSocket Integration initialized")
    ...
    async def stream_agent_response(
        ...
        try:
            ...
            ws_agent_type = self.agent_type_mapping.get(
                agent_response.agent_type, AutonomousAgentType.ASSISTANT
            )
    ...
    async def broadcast_agent_status(
        ...
        """
        try:
            ws_agent_type = self.agent_type_mapping.get(agent_type, AutonomousAgentType.ASSISTANT)
    ...
    async def _send_complete_response(
        self, conversation_id: str, agent_response: AutonomousAgentResponse, agent_type: AutonomousAgentType
    ):
    ...
    async def _send_typing_indicator(
        self, conversation_id: str, agent_type: AutonomousAgentType, is_typing: bool
    ):
    ...
    async def _send_approval_notification(
        ...
        try:
            notification_event = create_system_alert_event(
                ...
                message=f"AutonomousAgent recommendation requires approval. ID: {approval_result['approval_id']}",
...
# Global instance
agent_websocket_integration = ConversationalAutonomousAgentWebSocketIntegration()
