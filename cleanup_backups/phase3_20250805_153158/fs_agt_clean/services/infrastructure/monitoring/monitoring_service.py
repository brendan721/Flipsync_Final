...
from fs_agt_clean.core.monitoring.agent_monitor import AutonomousAgentEvent, AutonomousAgentMonitor
...
class MonitoringService:
    ...
    def __init__(
        ...
        self.monitor = AutonomousAgentMonitor(output_dir=f"{base_dir}/data")
