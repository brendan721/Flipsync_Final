...
class InventoryItem(Base):
    ...
    condition_ebay = Column(String(50))  # NEW, USED, LIKE_NEW, etc.
    marketplace_source = Column(String(50))  # eBay, Amazon, etc.
    metadata_json = Column(JSON)  # Item specifics, shipping, brand, images, etc.
    last_sync_at = Column(DateTime)  # Last sync with marketplace
    ...
    def __repr__(self):
        return (
            ...
            f"source='{self.marketplace_source}')>"
        )
