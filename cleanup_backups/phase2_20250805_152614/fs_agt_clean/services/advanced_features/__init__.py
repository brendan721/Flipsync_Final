...
# Brain service and decision engine removed - duplicate implementations
# Use core decision infrastructure in fs_agt_clean/core/coordination/decision/
BrainService = None
DecisionEngine = None
        ...
        try:
            return {
                ...
                "ai_integration": {
                    ...
                    "components": [
                        # "brain_service", - removed duplicate
                        # "decision_engine", - removed duplicate
                        "memory",
                        "patterns",
                        "strategy",
                    ],
