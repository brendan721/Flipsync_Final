...
class DecisionType(str, Enum):
    ...
    PRICING_OPTIMIZATION = "pricing_optimization"  # Decision to optimize pricing
    INVENTORY_MANAGEMENT = "inventory_management"  # Decision for inventory management
    CONTENT_OPTIMIZATION = "content_optimization"  # Decision to optimize content
    LOGISTICS_OPTIMIZATION = "logistics_optimization"  # Decision to optimize logistics
    STRATEGIC_PLANNING = "strategic_planning"  # Decision for strategic planning
...
class DecisionStatus(str, Enum):
    ...
    IN_PROGRESS = "in_progress"  # Decision is in progress
