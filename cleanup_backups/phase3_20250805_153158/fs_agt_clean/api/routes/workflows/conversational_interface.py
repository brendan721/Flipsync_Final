...
async def process_conversation(
    ...
    agent_manager: RealAutonomousAgentManager = Depends(get_agent_manager),
    pipeline_controller: PipelineController = Depends(get_pipeline_controller),
    state_manager: StateManager = Depends(get_state_manager),
    orchestration_service: AutonomousAgentOrchestrationService = Depends(get_orchestration_service),
):
    """
