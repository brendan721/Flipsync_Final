"""
Standardized Error Handling for FlipSync AutonomousAgents
...
class StandardErrorHandler:
    ...
    async def _log_error(self, error_details: Dict[str, Any], severity: ErrorSeverity):
        ...
        try:
            ...
            # Format log message
            log_message = (
                f"AutonomousAgent Error [{error_details['error_id']}] - "
                f"AutonomousAgent: {error_details['agent_type']}/{error_details['agent_id']} - "
    ...
    async def _send_alert(self, error_details: Dict[str, Any], severity: ErrorSeverity):
        ...
        try:
            ...
            alert = Alert(
                ...
                message=f"AutonomousAgent {error_details['agent_type']} error: {error_details['error_message']}",
