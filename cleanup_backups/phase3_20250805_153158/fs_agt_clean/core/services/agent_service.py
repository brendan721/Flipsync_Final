"""
AutonomousAgent service base class for FlipSync.
...
from fs_agt_clean.core.models.chat import AutonomousAgentResponse, ChatMessage, MessageIntent

logger = logging.getLogger(__name__)


class AutonomousAgentService(ABC):
    """
...
# MockAutonomousAgentService removed - FlipSync uses only real OpenAI-powered agents in production
