...
# Legacy enum kept for backward compatibility - use UnifiedAgentType from enums instead
class LegacyUnifiedAgentType(str, Enum):
    """DEPRECATED: Use fs_agt_clean.core.enums.agent_status.AgentType instead"""
...
# Legacy enums - DEPRECATED: Use imports from fs_agt_clean.core.enums.agent_status instead
# These are kept for backward compatibility but should not be used in new code


class LegacyUnifiedAgentStatus(str, Enum):
    """DEPRECATED: Use fs_agt_clean.core.enums.agent_status.UnifiedAgentStatus instead"""
...
class LegacyUnifiedAgentPriority(str, Enum):
    """DEPRECATED: Use fs_agt_clean.core.enums.agent_status.AgentPriority instead"""
...
class LegacyTaskStatus(str, Enum):
    """DEPRECATED: Use fs_agt_clean.core.enums.agent_status.TaskStatus instead"""
...
class LegacyDecisionStatus(str, Enum):
    """DEPRECATED: Use fs_agt_clean.core.enums.agent_status.DecisionStatus instead"""
...
class UnifiedAgent(Base):
    ...
    priority: Mapped[AgentPriority] = mapped_column(
        String(20), default=AgentPriority.MEDIUM
    )
    ...
    authority_level: Mapped[AgentPriority] = mapped_column(
        String(20), default=AgentPriority.MEDIUM
    )
...
# Note: These now point to the unified enums from fs_agt_clean.core.enums.agent_status
Agent = UnifiedAgent
...
# Export all models
__all__ = [
    # Enums (imported from fs_agt_clean.core.enums.agent_status)
    "UnifiedAgentStatus",
    "UnifiedAgentType",
    "AgentPriority",
    "TaskStatus",
    ...
    "LegacyUnifiedAgentType",
    "LegacyUnifiedAgentStatus",
    "LegacyUnifiedAgentPriority",
    "LegacyTaskStatus",
