...
class MetricsService:
    ...
    def __init__(
        ...
        self.metric_series_repository = MetricSeriesRepository()
        self.metric_aggregation_repository = MetricAggregationRepository()
...
def get_metrics_service() -> MetricsService:
    ...
    if _metrics_service_instance is None:
        from fs_agt.core.config.manager import ConfigManager
        from fs_agt.core.db.database import get_database
