...
class AmazonMarketAutonomousAgent(BaseMarketAutonomousAgent, MarketplaceAPIClient):
    """
    ...
    def __init__(
        ...
        BaseMarketAutonomousAgent.__init__(
            self,
            agent_id,
            "amazon",
    ...
    async def _setup_marketplace_client(self) -> None:
        ...
        self.default_headers = {
            ...
            "UnifiedUser-AutonomousAgent": f"FlipSync-AmazonAutonomousAgent/{self.agent_id}",
        }
...
AmazonAutonomousAgent = AmazonMarketAutonomousAgent
