...
class DashboardService:
    ...
    async def create_dashboard(self, dashboard_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Dashboard creation requires proper repository implementation
        # Mock data removed to prevent conflicts with real eBay data
        raise NotImplementedError(
            "Dashboard creation requires database repository implementation. "
            "Mock data has been removed to prevent conflicts with real data."
        )
    ...
    async def get_dashboard(self, dashboard_id: str) -> Optional[Dict[str, Any]]:
        ...
        # Mock data removed - dashboards require proper repository implementation
        logger.debug(f"Dashboard not found: {dashboard_id} (mock data removed)")
        return None
    ...
    async def get_dashboards_by_user(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        # Mock data removed - return empty list until proper repository is implemented
        return []
