...
- AutonomousAgent connectivity and coordination
...
try:
    from .agent_connectivity_service import AutonomousAgentConnectivityService
except ImportError:
    AutonomousAgentConnectivityService = None
...
class CommunicationService:
    ...
    def __init__(self, config_manager=None):
        ...
        self.agent_connectivity = (
            AutonomousAgentConnectivityService() if AutonomousAgentConnectivityService else None
        )
    ...
    async def connect_to_agent(self, user_id: str, agent_type: str) -> Dict:
        ...
        try:
            if not self.agent_connectivity:
                return {"connected": False, "error": "AutonomousAgent connectivity not available"}
...
__all__ = [
    ...
    "ChatService",
    "AutonomousAgentConnectivityService",
    "ContextManager",
