...
def integrate_endpoints():
    ...
    mobile_router_position = new_content.find(
    ...
    if mobile_router_position == -1:
        ...
        router_position = new_content.find(
            "app.include_router(websocket_unified_router"
        )
...
def restart_backend():
    ...
    try:
        ...
        result = subprocess.run(
            ["pgrep", "-f", "uvicorn.*fs_agt_clean"], capture_output=True, text=True
        )
