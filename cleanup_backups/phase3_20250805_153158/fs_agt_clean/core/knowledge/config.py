...
# AutonomousAgent types that are authorized to validate specific knowledge types
AUTHORIZED_VALIDATORS = {
    "PRICING_STRATEGY": ["PricingAutonomousAgent", "ExecutiveAutonomousAgent"],
    "INVENTORY_PREDICTION": ["LogisticsAutonomousAgent", "ExecutiveAutonomousAgent"],
    "OPERATIONAL_INSIGHT": ["LogisticsAutonomousAgent", "ExecutiveAutonomousAgent"],
    "COMPETITOR_ANALYSIS": ["MarketAutonomousAgent", "ExecutiveAutonomousAgent"],
    "MARKET_INSIGHT": ["MarketAutonomousAgent", "ExecutiveAutonomousAgent"],
    "CUSTOMER_BEHAVIOR": ["MarketAutonomousAgent", "ContentAutonomousAgent", "ExecutiveAutonomousAgent"],
    "GENERAL": ["ExecutiveAutonomousAgent"],
}
...
class KnowledgeSharingConfig:
    ...
    def __init__(
        ...
        Args:
            ...
            authorized_validators: AutonomousAgent types authorized to validate each knowledge type
