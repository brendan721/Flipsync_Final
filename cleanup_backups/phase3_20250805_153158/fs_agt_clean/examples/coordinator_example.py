...
agent registration, discovery, and task delegation. These are NOT the production
...
class ExampleMarketAgent:
    """
    ⚠️  EXAMPLE AGENT - NOT PRODUCTION CODE ⚠️

    Example agent that demonstrates coordinator usage.
    This is NOT the production MarketAutonomousAgent.
    """

    def __init__(self):
        """Initialize the market agent."""
        self.agent_id = "market_agent"
        self.name = "Market AutonomousAgent"
        self.description = "Provides market data and analysis"
        self.agent_type = AutonomousAgentType.SPECIALIST
...
class ExampleExecutiveAgent:
    """
    ⚠️  EXAMPLE AGENT - NOT PRODUCTION CODE ⚠️

    Example agent that demonstrates coordinator usage.
    This is NOT the production ExecutiveAutonomousAgent.
    """

    def __init__(self):
        """Initialize the executive agent."""
        self.agent_id = "executive_agent"
        self.name = "Executive AutonomousAgent"
        self.description = "Makes executive decisions based on market data"
        self.agent_type = AutonomousAgentType.EXECUTIVE
    ...
    async def make_investment_decision(self, market, symbol):
        ...
        market_data_capability = AutonomousAgentCapability(
        ...
        market_analysis_capability = AutonomousAgentCapability(
...
async def main():
    ...
    # Create example agents (NOT production agents)
    market_agent = ExampleMarketAgent()
    executive_agent = ExampleExecutiveAgent()
