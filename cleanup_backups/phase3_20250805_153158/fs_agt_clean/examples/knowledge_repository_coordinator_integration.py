...
⚠️  EXAMPLE CODE ONLY - NOT PRODUCTION AGENTS ⚠️

This example demonstrates how to integrate the Knowledge Repository with the Coordinator
component to enable knowledge sharing between agents. These are NOT the production
autonomous agents (MarketAutonomousAgent, ExecutiveAutonomousAgent, etc.).

Production agents are located in:
- fs_agt_clean/agents/market/market_agent.py (MarketAutonomousAgent)
- fs_agt_clean/agents/executive/executive_agent.py (ExecutiveAutonomousAgent)
- fs_agt_clean/agents/content/content_agent.py (ContentAutonomousAgent)
- fs_agt_clean/agents/logistics/logistics_agent.py (LogisticsAutonomousAgent)
"""
...
class ExampleKnowledgeAgent(AutonomousAgent):
    """
    ⚠️  EXAMPLE AGENT - NOT PRODUCTION CODE ⚠️

    Example agent that demonstrates knowledge repository integration.
    ...
    def __init__(
        ...
        capabilities: Set[AutonomousAgentCapability],
        ...
        Args:
            agent_id: AutonomousAgent ID
            name: AutonomousAgent name
            agent_type: AutonomousAgent type
    ...
    async def start(self) -> None:
        ...
        self.status = AutonomousAgentStatus.ACTIVE
    ...
    async def stop(self) -> None:
        ...
        self.status = AutonomousAgentStatus.INACTIVE
    ...
    async def handle_knowledge_added(self, event: Event) -> None:
        ...
        logger.info(
            f"AutonomousAgent {self.name} received knowledge added event: {knowledge_id} ({topic})"
        )
    ...
    async def handle_knowledge_update(self, knowledge: KnowledgeItem) -> None:
        ...
        """
        logger.info(
            f"AutonomousAgent {self.name} received knowledge update: {knowledge.knowledge_id} ({knowledge.topic})"
        )
    ...
    async def publish_knowledge(
        ...
        logger.info(
            f"AutonomousAgent {self.name} published knowledge: {knowledge_id} ({topic})"
        )

        return knowledge_id


class MarketAutonomousAgent(KnowledgeAutonomousAgent):
    """
    AutonomousAgent that provides market knowledge.
    """
    ...
    def __init__(self, knowledge_repository: InMemoryKnowledgeRepository):
        ...
        super().__init__(
            ...
            name="Market AutonomousAgent",
            agent_type=AutonomousAgentType.SPECIALIST,
            capabilities={AutonomousAgentCapability.MARKET_ANALYSIS},
...
class AnalysisAutonomousAgent(KnowledgeAutonomousAgent):
    """
    AutonomousAgent that analyzes market knowledge.
    """
    ...
    def __init__(self, knowledge_repository: InMemoryKnowledgeRepository):
        ...
        super().__init__(
            ...
            name="Analysis AutonomousAgent",
            agent_type=AutonomousAgentType.SPECIALIST,
            capabilities={AutonomousAgentCapability.DATA_ANALYSIS},
            knowledge_repository=knowledge_repository,
        )
...
class ExecutiveAutonomousAgent(KnowledgeAutonomousAgent):
    """
    AutonomousAgent that makes executive decisions based on analysis.
    """
    ...
    def __init__(self, knowledge_repository: InMemoryKnowledgeRepository):
        ...
        super().__init__(
            ...
            name="Executive AutonomousAgent",
            agent_type=AutonomousAgentType.EXECUTIVE,
            capabilities={AutonomousAgentCapability.DECISION_MAKING},
            knowledge_repository=knowledge_repository,
        )
...
async def main():
    ...
    # Create agents
    market_agent = MarketAutonomousAgent(repository)
    analysis_agent = AnalysisAutonomousAgent(repository)
    executive_agent = ExecutiveAutonomousAgent(repository)
