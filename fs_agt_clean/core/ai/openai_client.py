...
class OpenAIModel(str, Enum):
    ...
    GPT_4O_MINI = "gemini-pro-mini"  # $0.15/1M input, $0.60/1M output

    # Advanced models for complex tasks
    GPT_4O = "gemini-pro"  # $2.50/1M input, $10.00/1M output
    GPT_4O_LATEST = "gemini-pro-2024-11-20"  # Latest with vision + function calling
...
class FlipSyncOpenAIClient:
    ...
    def __init__(self, config: OpenAIConfig):
        ...
        self.client = AsyncHybridLLMClient()
