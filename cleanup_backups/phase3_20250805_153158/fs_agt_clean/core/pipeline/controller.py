...
from fs_agt_clean.core.protocols.agent_protocol import AutonomousAgentCategoryType
from fs_agt_clean.core.coordination.coordinator.agent_registry import AutonomousAgentRegistry
...
class PipelineStage:
    ...
    def __init__(
        self,
        stage_id: str,
        category: AutonomousAgentCategoryType,
        required: bool = True,
        timeout: float = 30.0,
        retry_count: int = 1,
        ...
        Args:
            ...
            category: AutonomousAgent category for this stage
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PipelineStage":
        ...
        return cls(
            ...
            category=AutonomousAgentCategoryType(data["category"]),
...
class PipelineController:
    ...
    def __init__(
        self, agent_registry: Optional[AutonomousAgentRegistry] = None, agent_manager=None
    ):
        """Initialize pipeline controller.

        Args:
            agent_registry: AutonomousAgent registry for agent discovery (optional)
        ...
        # AutonomousAgent coordination tracking
    ...
    def _setup_agent_manager_integration(self):
        ...
        try:
            logger.info("Setting up Pipeline Controller integration with AutonomousAgent Manager")
            ...
            logger.info(
                "Pipeline Controller successfully integrated with AutonomousAgent Manager"
            )

        except Exception as e:
            logger.error(
                f"Failed to integrate Pipeline Controller with AutonomousAgent Manager: {e}"
            )
    ...
    async def setup_agent_communication_protocol(self):
        ...
        try:
            ...
            logger.info("AutonomousAgent communication protocol initialized successfully")
    ...
    async def _setup_agent_communication_handlers(self):
        ...
        try:
            ...
            logger.info("AutonomousAgent communication handlers set up successfully")
    ...
    def _initialize_templates(self) -> None:
        ...
        pricing_stages = [
            PipelineStage("executive", AutonomousAgentCategoryType.EXECUTIVE),
            PipelineStage("market", AutonomousAgentCategoryType.MARKET),
        ]
        ...
        inventory_stages = [
            PipelineStage("executive", AutonomousAgentCategoryType.EXECUTIVE),
            PipelineStage("market", AutonomousAgentCategoryType.MARKET),
            PipelineStage("logistics", AutonomousAgentCategoryType.LOGISTICS),
        ]
        ...
        content_stages = [
            PipelineStage("executive", AutonomousAgentCategoryType.EXECUTIVE),
            PipelineStage("content", AutonomousAgentCategoryType.CONTENT),
            PipelineStage("market", AutonomousAgentCategoryType.MARKET, required=False),
        ]
    ...
    async def _execute_stage_with_agent_manager(
        ...
        category_mapping = {
            AutonomousAgentCategoryType.MARKET: [
                "market_agent",
                "amazon_agent",
                "ebay_agent",
                "inventory_agent",
            ],
            AutonomousAgentCategoryType.EXECUTIVE: [
                "executive_agent",
                "strategy_agent",
                "resource_agent",
            ],
            AutonomousAgentCategoryType.CONTENT: [
                "content_agent",
                "listing_agent",
                "auto_listing_agent",
            ],
            AutonomousAgentCategoryType.LOGISTICS: [
                "logistics_agent",
                "shipping_agent",
                "warehouse_agent",
            ],
    ...
    async def _execute_agent_task(
        ...
        try:
            ...
            if stage.category == AutonomousAgentCategoryType.MARKET:
                return await self._execute_market_task(agent_instance, task_context)
            elif stage.category == AutonomousAgentCategoryType.EXECUTIVE:
                return await self._execute_executive_task(agent_instance, task_context)
            elif stage.category == AutonomousAgentCategoryType.CONTENT:
                return await self._execute_content_task(agent_instance, task_context)
            elif stage.category == AutonomousAgentCategoryType.LOGISTICS:
