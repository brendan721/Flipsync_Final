"""
AutonomousAgent Message Router for FlipSync AutonomousAgent Communication Protocol.

This module provides the infrastructure for structured inter-agent messaging
using the AutonomousAgentMessage protocol and event system integration.
"""
...
class AutonomousAgentMessageRouter:
    """
    Router for agent-to-agent communication using the AutonomousAgentMessage protocol.
    ...
    def __init__(self, agent_manager=None):
        ...
        self.active_conversations: Dict[str, List[AutonomousAgentMessage]] = {}
        self.message_history: List[AutonomousAgentMessage] = []

        logger.info("AutonomousAgent Message Router initialized")

    async def initialize(self) -> bool:
        """Initialize the message router."""
        try:
            logger.info("Initializing AutonomousAgent Message Router...")

            # Event bus is already initialized in constructor
            # Register default message handlers
            await self._register_default_handlers()

            logger.info("AutonomousAgent Message Router initialization completed")
            return True

        except Exception as e:
            logger.error(f"Failed to initialize AutonomousAgent Message Router: {e}")
            return False
    ...
    async def register_agent(self, agent_id: str, message_handler: Callable) -> bool:
        ...
        try:
            ...
            logger.info(f"AutonomousAgent {agent_id} registered for message routing")
            return True
    ...
    async def send_message(self, message: AutonomousAgentMessage) -> bool:
        """
        Send a message from one agent to another.

        Args:
            message: The AutonomousAgentMessage to send
        ...
        try:
            ...
            # Convert AutonomousAgentMessage to Event
    ...
    async def broadcast_message(
        self, message: AutonomousAgentMessage, agent_category: Optional[str] = None
    ) -> int:
        """
        Broadcast a message to multiple agents.

        Args:
            message: The AutonomousAgentMessage to broadcast
        ...
        try:
            ...
            for recipient_id in recipients:
                if recipient_id != message.sender_id:  # Don't send to self
                    ...
                    recipient_message = AutonomousAgentMessage(
    ...
    def _convert_message_to_event(self, message: AutonomousAgentMessage) -> BaseEvent:
        """Convert an AutonomousAgentMessage to an Event for the event bus."""
    ...
    def _convert_event_to_message(self, event: BaseEvent) -> AutonomousAgentMessage:
        """Convert an Event back to an AutonomousAgentMessage."""
        msg_data = event.payload["agent_message"]

        return AutonomousAgentMessage(
    ...
    def _create_message_handler(self, agent_id: str, handler: Callable):
        ...
        async def handle_event(event: BaseEvent):
            try:
                # Convert event back to AutonomousAgentMessage
                ...
                if response and isinstance(response, AutonomousAgentMessage):
    ...
    async def get_conversation_history(self, correlation_id: str) -> List[AutonomousAgentMessage]:
    ...
    async def shutdown(self):
        ...
        try:
            ...
            logger.info("AutonomousAgent Message Router shutdown completed")
