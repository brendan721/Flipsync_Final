...
class EnhancedRealTimeAgentCommunication:
    ...
    def __init__(self):
        ...
        self.autonomous_agents = {
            "market_agent": AutonomousAgentType.MARKET,
            "executive_agent": AutonomousAgentType.EXECUTIVE,
            "content_agent": AutonomousAgentType.CONTENT,
            "logistics_agent": AutonomousAgentType.LOGISTICS,
        }
        ...
        try:
            if agent_id in self.agent_connections:
                ...
                status_event = create_agent_status_event(
                    agent_id=agent_id,
                    agent_type=self.autonomous_agents.get(agent_id, AutonomousAgentType.ASSISTANT),
                    status=status,
                    metrics={
