"""
Real-time AutonomousAgent Status Dashboard for FlipSync Frontend Integration.

This module provides comprehensive real-time monitoring capabilities for FlipSync's
sophisticated 4+1 autonomous agent architecture with workflow progress visualization
...
class AutonomousAgentStatusMetrics(BaseModel):
    """AutonomousAgent status metrics for dashboard display."""

    agent_id: str = Field(description="AutonomousAgent identifier")
    agent_type: str = Field(description="AutonomousAgent type category")
    status: str = Field(description="Current agent status")
    health_score: float = Field(description="AutonomousAgent health score (0-1)")
    ...
    capabilities: List[str] = Field(description="AutonomousAgent capabilities")
    utilization_percentage: float = Field(
        description="AutonomousAgent utilization percentage"
    )
...
class WorkflowProgressMetrics(BaseModel):
    ...
    agents_involved: List[str] = Field(
        description="AutonomousAgents participating in workflow"
    )
...
class DashboardUpdate(BaseModel):
    ...
    agent_metrics: Optional[List[AutonomousAgentStatusMetrics]] = Field(
        description="AutonomousAgent status updates"
    )
...
class RealTimeDashboardService:
    ...
    def __init__(
        ...
        self.agent_metrics_cache: Dict[str, AutonomousAgentStatusMetrics] = {}
    ...
    async def _agent_health_monitoring_loop(self):
        ...
        try:
            ...
            logger.info("AutonomousAgent health monitoring loop cancelled")
        except Exception as e:
        ...
        try:
            ...
            for agent_id in available_agents:
                ...
                if agent_id in self.agent_metrics_cache:
                    ...
                    metrics = AutonomousAgentStatusMetrics(
                        agent_id=agent_id,
