...
# Temporary alias for backward compatibility with legacy unified_agent.py
# This will be removed in Phase 3 when unified_agent.py is deleted
UnifiedAgentStatus = AutonomousAgentStatus
