...
void main() {
  ...
  group('Network Error Handling', () {
    ...
    test('handles server errors', () {
      ...
      expect(networkState.isOnline, isTrue); // Server errors don't affect online status
    });
    ...
    test('handles connection errors', () {
      ...
      networkState.setOffline(); // Connection errors should set offline status
    ...
    test('error state is preserved until cleared', () {
      ...
      networkState.setLoading(true);
      expect(networkState.error, isNotNull); // Error persists through loading state
      networkState.setLoading(false);
      expect(networkState.error, isNotNull);
