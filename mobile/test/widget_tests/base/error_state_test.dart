...
void main() {
  group('ErrorState Widget Tests', () {
    ...
    testWidgets('renders with required properties', (tester) async {
      ...
      expect(icon.color, equals(FlipSyncColors.error));
      expect(icon.size, equals(80));

      // Verify title
      expect(find.text(testTitle), findsOneWidget);
      final titleWidget = tester.widget<Text>(find.text(testTitle));
      expect(titleWidget.style?.color, equals(FlipSyncColors.error));
      ...
      expect(messageWidget.style?.fontSize, equals(16.0));
