...
PRODUCTION_API_BASE = 'http://localhost:8000'
...
REDIS_EXTERNAL = 'redis://localhost:6379'
...
class EbayOAuthInvestigator:
    ...
    async def __aenter__(self):
        ...
        try:
            ...
            print("✅ External Redis (localhost:6379): Connected")
        except Exception as e:
            print(f"❌ External Redis (localhost:6379): {e}")
