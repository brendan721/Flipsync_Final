...
class AgentRegistry:
        ...
        try:
            with self._registry_lock:
                ...
                registered_agent = RegisteredAgent(
                    ...
                    status=AutonomousAgentStatus.INITIALIZING,
                    priority=priority,
                    instance=instance,
    ...
    async def unregister_agent(self, agent_id: str) -> bool:
        ...
        try:
            with self._registry_lock:
                ...
                await self.update_agent_status(agent_id, AutonomousAgentStatus.STOPPED)
    ...
    async def update_agent_status(
        self, agent_id: str, new_status: AutonomousAgentStatus
    ) -> bool:
        """
