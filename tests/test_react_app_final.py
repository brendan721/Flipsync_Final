    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            result = subprocess.run(
                ["ssh", "root@localhost", "redis-cli -n 1 exists 'marketplace:ebay:test_user_id'"],
...
async def main():
    ...
    if success:
        ...
        print("   📱 React Frontend: http://localhost:8000/testing-frontend/")
        print("   🔧 Backend API: http://localhost:8000/api/v1/")
        print("   🔌 WebSocket: ws://localhost:8000/ws/flipsync")
        print("   💾 Redis Storage: localhost:6379 (database 1)")
        print("   🗄️  PostgreSQL: localhost:5432 (flipsync_agentic_test)")
