...
class EnhancedVisionService:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # Initialize model clients - Phase 2 production only (no Ollama fallbacks)
        self.model_clients = {}
        self.fallback_order = [
            VisionModelProvider.OPENAI_GPT4O_MINI,  # Primary: Cost-effective
            VisionModelProvider.OPENAI_GPT4O,  # Fallback: High-quality
            # REMOVED: OLLAMA_LLAVA - Phase 2 uses CLIP/BLIP-2 + OpenAI strategic escalation
        ]
