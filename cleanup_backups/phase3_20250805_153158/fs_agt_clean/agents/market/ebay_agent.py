...
class EbayMarketAutonomousAgent(BaseMarketAutonomousAgent, MarketplaceAPIClient):
    ...
    async def accept_cancellation_request(self, order_id, request_id):
        ...
        try:
            ...
            await self._make_api_call("post", endpoint)
...
EbayAutonomousAgent = EbayMarketAutonomousAgent
