...
class AutonomousAgentType(str, Enum):
    """AutonomousAgent types for routing and identification."""
...
class AutonomousAgentStatusData(BaseModel):
    """AutonomousAgent status data."""
...
class AutonomousAgentStatusEvent(BaseWebSocketEvent):
    """AutonomousAgent status update event."""

    type: EventType = EventType.AGENT_STATUS
    data: AutonomousAgentStatusData


class AutonomousAgentDecisionData(BaseModel):
    """AutonomousAgent decision data."""
...
class AutonomousAgentDecisionEvent(BaseWebSocketEvent):
    """AutonomousAgent decision event."""

    type: EventType = EventType.AGENT_DECISION
    data: AutonomousAgentDecisionData


class AutonomousAgentTaskData(BaseModel):
    """AutonomousAgent task data."""
...
class AutonomousAgentTaskEvent(BaseWebSocketEvent):
    """AutonomousAgent task update event."""

    type: EventType = EventType.AGENT_TASK_UPDATE
    data: AutonomousAgentTaskData
...
class AutonomousAgentResponseStreamData(BaseModel):
    """AutonomousAgent response streaming data."""
...
class AutonomousAgentResponseStreamEvent(BaseWebSocketEvent):
    """AutonomousAgent response streaming event."""

    type: EventType = EventType.AGENT_RESPONSE_STREAM
    conversation_id: str
    data: AutonomousAgentResponseStreamData
...
class AutonomousAgentCoordinationData(BaseModel):
    """AutonomousAgent coordination data."""
...
class AutonomousAgentCoordinationEvent(BaseWebSocketEvent):
    """AutonomousAgent coordination event."""

    type: EventType = EventType.AGENT_COORDINATION
    conversation_id: Optional[str] = None
    data: AutonomousAgentCoordinationData
...
WebSocketEvent = Union[
    ...
    AutonomousAgentStatusEvent,
    AutonomousAgentDecisionEvent,
    AutonomousAgentTaskEvent,
    SystemAlertEvent,
    ErrorEvent,
    ConversationEvent,
    ApprovalEvent,
    AutonomousAgentResponseStreamEvent,
    WorkflowEvent,
    AutonomousAgentCoordinationEvent,
]
...
def create_agent_status_event(
    ...
    return AutonomousAgentStatusEvent(
        data=AutonomousAgentStatusData(
            agent_id=agent_id,
            agent_type=agent_type,
            status=status,
...
def create_agent_response_stream_event(
    ...
    return AutonomousAgentResponseStreamEvent(
...
def create_agent_coordination_event(
    ...
    return AutonomousAgentCoordinationEvent(
        conversation_id=conversation_id,
        data=AutonomousAgentCoordinationData(
